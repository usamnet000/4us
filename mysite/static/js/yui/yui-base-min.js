...
var YUI = function() {
    ...
    i(t, YUI) ? (t._init(), YUI.GlobalConfig && t.applyConfig(YUI.GlobalConfig), s && t.applyConfig(s), r || (t._afterConfig(), t._setup())) : t = new YUI;
    if (r) {
...
(function() {
    ...
    n._isNative = function(t) {
        ...
        function n(e, t) {
            ...
            if (r && typeof e[t] == "object" && e[t] !== null) return n(e[t], r)
        }
